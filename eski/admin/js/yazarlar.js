        ...
        html += `
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <div class="relative overflow-hidden">
                    <img src="${author.photo_url || '../site_resimleri/placeholder.png'}" alt="${author.name}" 
...
function editAuthor(authorId) {
    ...
    getAuthorById(authorId).then(author => {
        ...
        if (authorPreview) {
            authorPreview.src = author.photo_url || '../site_resimleri/placeholder.png';
        }
    ...
    try {
        ...
        return new Promise((resolve) => {
            ...
            reader.onload = (e) => {
                ...
                resolve('../site_resimleri/placeholder.png');
            };
            reader.readAsDataURL(file);
        });
    } catch (error) {
