...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    if (addBookButton) {
        addBookButton.addEventListener('click', function() {
            ...
            document.getElementById('bookCoverPreview').src = '../site_resimleri/placeholder.png';
                ...
                <div class="book-card bg-white rounded-xl shadow-sm overflow-hidden border border-gray-200 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 h-[520px] flex flex-col">
                    <div class="relative group flex-shrink-0">
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 h-80 w-full flex items-center justify-center overflow-hidden">
                            <img src="${book.cover_url || '../site_resimleri/placeholder.png'}" alt="${book.title}" class="max-h-full max-w-full object-contain p-2 transition-all duration-300 group-hover:scale-105">
                        </div>
...
async function editBook(bookId) {
    try {
        ...
        // Yazar adını input alanına yaz
        document.getElementById('bookAuthor').value = book.authors ? book.authors.name : '';
        ...
        document.getElementById('bookCoverPreview').src = book.cover_url || '../site_resimleri/placeholder.png';
            ...
            if (file) {
                try {
                    ...
                    if (window.ImageScaler) {
                        ...
                        previewImage.src = '../site_resimleri/placeholder.png';
